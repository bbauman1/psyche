    ...
    switch (route.key) {
      ...
      case "second":
        sections = [
          ...
          {
            title:
              "Where does the Gamma Ray and Neutron Spectrometer team based?",
            content:
          ...
          {
            title:
              "What is The Psyche’s Deep Space Optical Communication (DSOC)?",
            content:
      ...
      case "third":
        sections = [
          ...
          },
          {
            ...
            content:
              "Psyche is dense--perhaps as dense as 7,000 kilograms per cubic meter (kg/m3) (similar to the density of a bar of steel)."
          },
          {
