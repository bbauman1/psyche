        ...
        sections = [
          {
            ...
            uri: 'http://ichef.bbci.co.uk/wwfeatures/wm/live/1280_640/images/live/p0/5x/h5/p05xh5dx.jpg'
          },
          {
  ...
  _renderHeader(section) {
    return (
      <View style = {styles.container}>
        <ImageBackground style = {{flex: 1, width: '100%', height: 55}} source = {{uri: section.uri}}> 
